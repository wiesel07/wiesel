package com.wiesel.common.enums.handler;
...
import com.wiesel.common.enums.BaseEnum;

/**
 *
 * @ClassName 类名：UniversalEnumHandler
 * @Description 功能说明：转至http://blog.csdn.net/fighterandknight/article/details/51520595
 *              <p>
 *              TODO
 *              </p>
 ************************************************************************
...
public final class UniversalEnumHandler<E extends BaseEnum<?, ?>> extends BaseTypeHandler<E> {  
    ...
    public void setNonNullParameter(PreparedStatement ps, int i, E parameter,  
    	...
    	if(jdbcType == null) {
    		//未指定时 默认为 VARCHAR类型存储
    		jdbcType = JdbcType.VARCHAR;
    	}
    	Object objVal = parameter.getValue();
